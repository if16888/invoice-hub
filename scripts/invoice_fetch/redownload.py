    ...
    *,
    ...
    def ensure_mail_fetcher(mailbox_key: str):
        ...
        try:
            ...
            # Keep small legacy test doubles/integrations which predate the
            # optional control argument working; production MailFetcher gets
            # the cancellation token above.
