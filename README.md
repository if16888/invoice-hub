...
> **v0.1.7 发布状态：**正式版已发布；自动化、真实 Windows、手机上传、v0.1.6 升级与数据保留验收记录见 [v0.1.7 Release Acceptance](docs/release/v0.1.7-release-acceptance.md)。
...
> `v0.1.7` 是当前稳定版。`v0.1.7-rc1` 仅作为发布前验收记录保留；普通用户请安装不带 `-rc` 后缀的正式版资产。
...
- v0.1.7 已完成自动化、真实 Windows 与手机、v0.1.6 升级及数据保留验收，并作为当前稳定版发布。
