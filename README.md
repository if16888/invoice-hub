...
| --- | --- | --- | --- |
| [Invoice Hub v0.1.8](https://github.com/if16888/invoice-hub/releases/tag/v0.1.8) | [v0.1.7](https://github.com/if16888/invoice-hub/releases/tag/v0.1.7) | v0.1.8 Stable | 普通用户使用 v0.1.8 官方 Release |

> **v0.1.6 发布状态：**历史稳定版，官方 tag、Release 和资产保持不变。

> **v0.1.8 发布状态：**正式版已发布；功能源代码冻结在 post-#126 提交，自动化验证记录见 [v0.1.8 Release notes](docs/release-notes/v0.1.8.md)。
...
> `v0.1.8` 是当前稳定版；普通用户请安装不带 `-rc` 后缀的正式版资产。
...
当前不建议：一次性导入大量正式材料并完全依赖自动解析结果。稳定用户请使用 v0.1.8 官方 Release，并继续人工复核解析结果和导出材料。
...
- v0.1.8 已完成 post-#126 功能源代码的自动化验证，并作为当前稳定版发布；真实安装环境仍应按 Windows 安装说明完成本机校验。
