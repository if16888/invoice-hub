...
| --- | --- | --- | --- |
| [Invoice Hub v0.1.6](https://github.com/if16888/invoice-hub/releases/tag/v0.1.6) | 暂无 | Stable / 已发布 | 普通用户使用 v0.1.6；历史 RC 仅作为验收记录保留 |
...
> `v0.1.6` 是当前稳定版。RC1、RC2、RC3 仅作为历史候选和验收记录保留，不建议普通用户安装。
...
当前不建议：一次性导入大量正式材料并完全依赖自动解析结果。稳定用户请使用 v0.1.6 官方 Release，不要把 RC 候选版作为长期部署版本。
...
- v0.1.6 已完成自动化、真实 Windows 与手机、升级及数据保留验收；stable 用户应使用 v0.1.6 官方 Release。
