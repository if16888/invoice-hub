...
| --- | --- | --- | --- |
| [Invoice Hub v0.1.6](https://github.com/if16888/invoice-hub/releases/tag/v0.1.6) | v0.1.7 release preparation（尚未发布） | v0.1.6 Stable / v0.1.7 RC 准备中 | 普通用户使用 v0.1.6；v0.1.7 仅用于候选验证 |

> **v0.1.6 发布状态：**自动化、真实 Windows 与手机、升级及数据保留验收均已完成；普通用户请使用 v0.1.6 官方 Release。

> **v0.1.7 状态：**当前处于 release preparation；候选包、升级验证和最终发布门禁尚未完成，不代表 v0.1.7 已发布。
...
> `v0.1.6` 仍是当前稳定版。v0.1.7 release candidate 尚未发布；RC1、RC2、RC3 仅作为 v0.1.6 的历史候选和验收记录保留，不建议普通用户安装。
...
当前不建议：一次性导入大量正式材料并完全依赖自动解析结果。稳定用户请使用 v0.1.6 官方 Release；v0.1.7 仍处于 release preparation，不要作为长期部署版本。
...
- v0.1.6 已完成自动化、真实 Windows 与手机、升级及数据保留验收；v0.1.7 的候选验证正在进行，stable 用户仍应使用 v0.1.6 官方 Release。
