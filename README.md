...
| --- | --- | --- | --- |
| [Invoice Hub v0.1.5](https://github.com/if16888/invoice-hub/releases/tag/v0.1.5) | Invoice Hub v0.1.5-rc7 | Stable / 已发布 | 普通用户使用 v0.1.5；RC7 仅作为历史候选版本保留 |

> **v0.1.5 发布状态：**RC7 已完成人工验收，未发现阻断问题；普通用户请使用 v0.1.5 官方 Release。
...
> `v0.1.5-rc7` 是已完成验收的发布候选；稳定用户请使用 v0.1.5 官方 Release。
...
当前不建议：一次性导入大量正式材料并完全依赖自动解析结果，稳定用户请使用 v0.1.5 官方 Release，不要把 RC 候选版作为长期部署版本。
...
- v0.1.5-rc7 已完成真实 Windows 安装、首次启动、HCI 和卸载验收，未发现阻断问题；stable 用户应使用 v0.1.5 官方 Release。
